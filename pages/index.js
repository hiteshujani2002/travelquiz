...
export default function Home() {
  ...
  <div class="container px-4 py-20 mx-auto">
    <div class="flex flex-col text-center w-full mb-20">
      <h1 class="sm:text-7xl text-2xl font-medium title-font mb-4 text-gray-900">Travel Quiz</h1>
      <p class="lg:w-2/3 mx-auto leading-relaxed text-base text-3xl">Let's find a perfect place for you.</p>
    </div>
